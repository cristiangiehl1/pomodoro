...
export function HomeView() {
  ...
  return (
    <main className="relative z-10 mx-auto flex w-full max-w-5xl flex-1 flex-col justify-center gap-5 px-4 pb-10 pt-6 sm:px-6">
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 lg:items-stretch">
        ...
        <SoftCard tone="meadow" className="flex flex-col p-5 sm:p-6">
